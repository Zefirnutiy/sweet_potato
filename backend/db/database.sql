...
CREATE TABLE "Level" (
    ...
    Take_Course boolean  default false,
    Apload_File boolean  default false,
    View_Your_Result boolean  default false,
    View_Other_Results boolean  default false,
...
CREATE TABLE Organization (
    ...
    Level_Id smallint  NOT null default 0,
...
CREATE TABLE Active_Test (
    ...
    Test_id int  NOT NULL,
    Client_Id int  NOT NULL,
    Training_test boolean default false,
...
-- Reference: Public_info_Client (table: Public_info)
alter table Public_info add constraint Public_info_Client
	FOREIGN KEY (Client_Id)
    REFERENCES Client (Id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
